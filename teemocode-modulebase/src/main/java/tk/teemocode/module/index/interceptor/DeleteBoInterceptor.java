...
@Component
@Aspect
public class DeleteBoInterceptor extends IndexActionInterceptor {
	@SuppressWarnings({"unchecked", "rawtypes"})
//	@AfterReturning("execution(* tk.teemocode.module.base.service.impl.LocalServiceImpl.delete(..))")
	public void after(JoinPoint jp) {
		...
		for(IndexItemConvertor convertor : convertors) {
			...
			getDeleteIndexItemProcessor().send(intexItem);
		}
	}
}
